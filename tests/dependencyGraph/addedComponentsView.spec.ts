  ...
  test.describe('filtering', () => {
    ...
    test.describe('remove filter', () => {
      test('can remove provider filter and restore providers', async ({ depGraphPageWithMockApps }) => {
        ...
        // Ensure view param is set to 'addedcomponents' before asserting
        const urlAfterRemove = new URL(page.url());
        urlAfterRemove.searchParams.set('view', 'addedcomponents');
        await page.goto(urlAfterRemove.toString());
      ...
      test('can remove consumer filter and restore consumers', async ({ depGraphPageWithMockApps }) => {
        ...
        // Ensure we are on the correct view before starting
        const initialUrl = new URL(page.url());
        initialUrl.searchParams.set('view', 'addedcomponents');
